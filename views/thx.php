<?
    ...
    */
    ...
    if(!empty($email)) {
        ...
        $msg['to'] = $email;
        $msg['bcc'] = isset($_GET['currency']) && strtolower($_GET['currency']) == 'usd' ? $debug_email : 'stuart@servinglibrary.org';
        ...
        $msg['text'] .= isset($_GET['currency']) && strtolower($_GET['currency']) == 'usd' ? 'US.' : 'EU.';
