...
$thispayment_amount_1 = "100.00";
$thispayment_amount_2 = "140.00";
$thispayment_amount_3 = "500.00";
$thispayment_amount_4 = "800.00";
	...
	($receiver_email == $thisreceiver_email)) 
{
	...
	$sql = "INSERT INTO 
			...
			(
				...
				'$contact_phone', '$payer_email', 
				'$payment_date', '$begin', '$end', 
				'$memo', '$txn_id'
			)";
	$result = MYSQL_QUERY($sql);
	...
	$sql = "INSERT INTO 
			...
			(
				'$created', 
				'$modified', 
				(SELECT id FROM objects WHERE name1 LIKE 'Subscribers'), 
				'$insertId'
			)";
