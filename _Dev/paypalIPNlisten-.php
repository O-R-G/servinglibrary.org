<?php
	...
	$IPNserver = "www.sandbox.paypal.com";		// staging
	$IPNemail = "dev@servinglibrary.org";		// staging
	// $IPNserver = "www.paypal.com";			// live
	// $IPNemail = "info@servinglibrary.org";	// live		
	...
	if ($debug) $debugString .= "\n1.0 $txn_type, $item_name1, $item_number1, $payment_status, $payment_amount, $payment_currency, $receiver_email : $first_name, $last_name, $address_street, $address_city, $address_state, $address_zip, $address_country, $payer_email, $payment_date, $txn_id, $memo";
